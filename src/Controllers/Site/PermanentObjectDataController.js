...
class PermanentObjectDataController extends BaseSiteModelController {
    ...
    {
        return new Promise((resolve, reject) => {
        	RequestHelper.getRequest(`/sites/${siteId}/permanent-object-data/${id}/comments`, queryParameters)
        	.then((data) => {
        		resolve(data);
        	})
        	.catch((error) => {
    ...
    {
        return new Promise((resolve, reject) => {
        	RequestHelper.postRequest(`/sites/${siteId}/permanent-object-data/${id}/comments`, json)
        	.then((result) => {
        		resolve(result);
        	})
        	.catch((error) => {
    ...
    {
        return new Promise((resolve, reject) => {
        	RequestHelper.getRequest(`/sites/${siteId}/permanent-object-data/${id}/comments/${commentId}`, queryParameters)
        	.then((data) => {
        		resolve(data);
        	})
        	.catch((error) => {
    ...
    {
        return new Promise((resolve, reject) => {
        	RequestHelper.patchRequest(`/sites/${siteId}/permanent-object-data/${id}/comments/${commentId}`, json)
        	.then((result) => {
        		resolve(result);
        	})
        	.catch((error) => {
