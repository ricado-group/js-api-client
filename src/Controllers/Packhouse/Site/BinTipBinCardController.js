...
import BinTipBinCardModel from '../../../Models/Packhouse/Site/BinTipBinCardModel';
...
class BinTipBinCardController
{
    ...
    static getOne(siteId, id)
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/bin-tip-bin-cards/${id}`)
            .then((result) => {
                let resolveValue = (function(){
                    return BinTipBinCardModel.fromJSON(result, siteId);
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.patchRequest(`/packhouse/sites/${siteId}/bin-tip-bin-cards/${id}`, updateData)
            .then((result) => {
                let resolveValue = (function(){
                    return BinTipBinCardModel.fromJSON(result, siteId);
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.deleteRequest(`/packhouse/sites/${siteId}/bin-tip-bin-cards/${id}`)
            .then((result) => {
                resolve(result ?? true);
            })
            .catch(error => reject(error));
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/bin-tip-bin-cards/${id}/comments`)
            .then((result) => {
                let resolveValue = (function(){
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.postRequest(`/packhouse/sites/${siteId}/bin-tip-bin-cards/${id}/comments`, {content})
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/bin-tip-bin-cards/${id}/comments/${commentId}`)
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.patchRequest(`/packhouse/sites/${siteId}/bin-tip-bin-cards/${id}/comments/${commentId}`, {content})
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.deleteRequest(`/packhouse/sites/${siteId}/bin-tip-bin-cards/${id}/comments/${commentId}`)
            .then((result) => {
                resolve(result ?? true);
            })
            .catch(error => reject(error));
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/bin-tip-bin-cards`, queryParameters)
            .then((result) => {
                let resolveValue = (function(){
                    if(Array.isArray(result) !== true)
                    {
                    ...
                    return result.map((resultItem) => {
                        return (function(){
                            return BinTipBinCardModel.fromJSON(resultItem, siteId);
                        }());
                    });
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.postRequest(`/packhouse/sites/${siteId}/bin-tip-bin-cards`, createData)
            .then((result) => {
                let resolveValue = (function(){
                    return BinTipBinCardModel.fromJSON(result, siteId);
                }());
 ...
 * 
 * @typedef {Object} BinTipBinCardController.GetAllQueryParameters
 * @property {string} [binTipId] The Bin Tip ID associated with this Bin Card
 * @property {string} [binTipBinId] The Bin ID associated with this Bin Card
 * @property {Date} [createdTimestampBegin] Filter by the Timestamp when this Bin Card was Created. Results Greater than or Equal to Timestamp
 * @property {Date} [createdTimestampEnd] Filter by the Timestamp when this Bin Card was Created. Results Less than or Equal to Timestamp
 ...
 * 
 * @typedef {Object} BinTipBinCardController.CreateData
 * @property {string} binTipId The Bin Tip ID associated with this Bin Card
 * @property {string} [binTipBinId] The Bin ID associated with this Bin Card
 * @property {Date} [createdTimestamp] When this Bin Card was Created
 * @property {?string} [image] A Base64 Encoded Image of the Bin Card
 * @memberof Controllers.Packhouse.Site
 */
 ...
 * 
 * @typedef {Object} BinTipBinCardController.UpdateData
 * @property {string} [binTipId] The Bin Tip ID associated with this Bin Card
 * @property {Date} [createdTimestamp] When this Bin Card was Created
 * @property {?string} [image] A Base64 Encoded Image of the Bin Card
 * @memberof Controllers.Packhouse.Site
 ...
 * A **UserAccount** Type
 * 
 * @typedef {Object} BinTipBinCardController.UserAccount
 ...
 * A **CommentItem** Type
 * 
 * @typedef {Object} BinTipBinCardController.CommentItem
 * @property {string} id The Comment ID
 * @property {BinTipBinCardController.UserAccount} userAccount 
