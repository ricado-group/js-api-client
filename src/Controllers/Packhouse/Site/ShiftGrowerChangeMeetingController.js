...
class ShiftGrowerChangeMeetingController
{
    ...
    static getOne(siteId, id)
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/shift-grower-change-meetings/${id}`)
            .then((result) => {
                let resolveValue = (function(){
                    return ShiftGrowerChangeMeetingModel.fromJSON(result, siteId);
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.patchRequest(`/packhouse/sites/${siteId}/shift-grower-change-meetings/${id}`, updateData)
            .then((result) => {
                let resolveValue = (function(){
                    return ShiftGrowerChangeMeetingModel.fromJSON(result, siteId);
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.deleteRequest(`/packhouse/sites/${siteId}/shift-grower-change-meetings/${id}`)
            .then((result) => {
                resolve(result ?? true);
            })
            .catch(error => reject(error));
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/shift-grower-change-meetings/${id}/comments`)
            .then((result) => {
                let resolveValue = (function(){
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.postRequest(`/packhouse/sites/${siteId}/shift-grower-change-meetings/${id}/comments`, {content})
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/shift-grower-change-meetings/${id}/comments/${commentId}`)
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.patchRequest(`/packhouse/sites/${siteId}/shift-grower-change-meetings/${id}/comments/${commentId}`, {content})
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.deleteRequest(`/packhouse/sites/${siteId}/shift-grower-change-meetings/${id}/comments/${commentId}`)
            .then((result) => {
                resolve(result ?? true);
            })
            .catch(error => reject(error));
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/shift-grower-change-meetings`, queryParameters)
            .then((result) => {
                let resolveValue = (function(){
                    if(Array.isArray(result) !== true)
                    {
                    ...
                    return result.map((resultItem) => {
                        return (function(){
                            return ShiftGrowerChangeMeetingModel.fromJSON(resultItem, siteId);
                        }());
                    });
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.postRequest(`/packhouse/sites/${siteId}/shift-grower-change-meetings`, createData)
            .then((result) => {
                let resolveValue = (function(){
                    return ShiftGrowerChangeMeetingModel.fromJSON(result, siteId);
                }());
 ...
 * 
 * @typedef {Object} ShiftGrowerChangeMeetingController.GetAllQueryParameters
 * @property {string} [packingLineId] The Packing Line ID this Grower Change Meeting is associated with
 * @property {string} [shiftId] The Shift ID this Grower Change Meeting is asssociated with
 * @property {string} [packrunId] The Packrun ID this Grower Change Meeting relates to
 * @property {Date} [createdTimestampBegin] Filter by the Timestamp when Grower Change Meetings were Created. Results Greater than or Equal to Timestamp
 * @property {Date} [createdTimestampEnd] Filter by the Timestamp when Grower Change Meetings were Created. Results Less than or Equal to Timestamp
 * @property {Date} [scheduledTimestampBegin] Filter by the Timestamp when Grower Change Meetings were Scheduled to Begin. Results Greater than or Equal to Timestamp
 * @property {Date} [scheduledTimestampEnd] Filter by the Timestamp when Grower Change Meetings were Scheduled to Begin. Results Less than or Equal to Timestamp
 * @property {Date} [startTimestampBegin] Filter by the Timestamp when Grower Change Meetings were Started. Results Greater than or Equal to Timestamp
 * @property {Date} [startTimestampEnd] Filter by the Timestamp when Grower Change Meetings were Started. Results Less than or Equal to Timestamp
 * @property {Date} [finishTimestampBegin] Filter by the Timestamp when Grower Change Meetings were Completed. Results Greater than or Equal to Timestamp
 * @property {Date} [finishTimestampEnd] Filter by the Timestamp when Grower Change Meetings were Completed. Results Less than or Equal to Timestamp
 * @property {Date} [updateTimestampBegin] Filter by the Timestamp when Grower Change Meetings were last Updated. Results Greater than or Equal to Timestamp
 * @property {Date} [updateTimestampEnd] Filter by the Timestamp when Grower Change Meetings were last Updated. Results Less than or Equal to Timestamp
 ...
 * 
 * @typedef {Object} ShiftGrowerChangeMeetingController.CreateData
 * @property {string} packingLineId The Packing Line ID this Grower Change Meeting is associated with
 * @property {string} [shiftId] The Shift ID this Grower Change Meeting is asssociated with
 * @property {Date} [createdTimestamp] When this Grower Change Meeting was Created
 * @property {Date} [scheduledTimestamp] When this Grower Change Meeting is Scheduled to Begin
 * @property {?Date} [startTimestamp] When this Grower Change Meeting was Started
 * @property {?Date} [finishTimestamp] When this Grower Change Meeting was Completed
 * @property {string} packrunId The Packrun ID this Grower Change Meeting relates to
 * @property {?number} [usefulRating] An Optional Rating between 1 and 10 on how Useful the Grower Change Meeting was
 * @memberof Controllers.Packhouse.Site
 */
 ...
 * 
 * @typedef {Object} ShiftGrowerChangeMeetingController.UpdateData
 * @property {string} [packingLineId] The Packing Line ID this Grower Change Meeting is associated with
 * @property {Date} [createdTimestamp] When this Grower Change Meeting was Created
 * @property {Date} [scheduledTimestamp] When this Grower Change Meeting is Scheduled to Begin
 * @property {?Date} [startTimestamp] When this Grower Change Meeting was Started
 ...
 * A **UserAccount** Type
 * 
 * @typedef {Object} ShiftGrowerChangeMeetingController.UserAccount
 ...
 * A **CommentItem** Type
 * 
 * @typedef {Object} ShiftGrowerChangeMeetingController.CommentItem
 * @property {string} id The Comment ID
 * @property {ShiftGrowerChangeMeetingController.UserAccount} userAccount 
