...
import FreshPackBinLotModel from '../../../Models/Packhouse/Site/FreshPackBinLotModel';
...
class FreshPackBinLotController
{
    ...
    static getOne(siteId, id)
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/freshpack-bin-lots/${id}`)
            .then((result) => {
                let resolveValue = (function(){
                    return FreshPackBinLotModel.fromJSON(result, siteId);
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.patchRequest(`/packhouse/sites/${siteId}/freshpack-bin-lots/${id}`, updateData)
            .then((result) => {
                let resolveValue = (function(){
                    return FreshPackBinLotModel.fromJSON(result, siteId);
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.deleteRequest(`/packhouse/sites/${siteId}/freshpack-bin-lots/${id}`)
            .then((result) => {
                resolve(result ?? true);
            })
            .catch(error => reject(error));
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/freshpack-bin-lots/${id}/comments`)
            .then((result) => {
                let resolveValue = (function(){
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.postRequest(`/packhouse/sites/${siteId}/freshpack-bin-lots/${id}/comments`, {content})
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/freshpack-bin-lots/${id}/comments/${commentId}`)
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.patchRequest(`/packhouse/sites/${siteId}/freshpack-bin-lots/${id}/comments/${commentId}`, {content})
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.deleteRequest(`/packhouse/sites/${siteId}/freshpack-bin-lots/${id}/comments/${commentId}`)
            .then((result) => {
                resolve(result ?? true);
            })
            .catch(error => reject(error));
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/freshpack-bin-lots`, queryParameters)
            .then((result) => {
                let resolveValue = (function(){
                    if(Array.isArray(result) !== true)
                    {
                    ...
                    return result.map((resultItem) => {
                        return (function(){
                            return FreshPackBinLotModel.fromJSON(resultItem, siteId);
                        }());
                    });
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.postRequest(`/packhouse/sites/${siteId}/freshpack-bin-lots`, createData)
            .then((result) => {
                let resolveValue = (function(){
                    return FreshPackBinLotModel.fromJSON(result, siteId);
                }());
 ...
 * 
 * @typedef {Object} FreshPackBinLotController.GetAllQueryParameters
 * @property {string} [binTipId] The Bin Tip ID this Bin Lot is associated with
 * @property {string} [binLotCode] The Bin Lot Code
 * @property {Date} [createdTimestampBegin] Filter by the Timestamp when this FreshPack Bin Lot was Created. Results Greater than or Equal to Timestamp
 * @property {Date} [createdTimestampEnd] Filter by the Timestamp when this FreshPack Bin Lot was Created. Results Less than or Equal to Timestamp
 ...
 * 
 * @typedef {Object} FreshPackBinLotController.CreateData
 * @property {string} binTipId The Bin Tip ID this Bin Lot is associated with
 * @property {string} [binLotCode] The Bin Lot Code
 * @property {Date} [createdTimestamp] When this Bin Lot was Created
 * @property {string[]} [packrunIds] An Array of Packrun IDs associated with this Bin Lot
 * @property {string[]} [binNumbers] An Array of Bin Numbers for this Bin Lot
 * @memberof Controllers.Packhouse.Site
 */
 ...
 * 
 * @typedef {Object} FreshPackBinLotController.UpdateData
 * @property {string} [binTipId] The Bin Tip ID this Bin Lot is associated with
 * @property {Date} [createdTimestamp] When this Bin Lot was Created
 * @property {string[]} [packrunIds] An Array of Packrun IDs associated with this Bin Lot
 * @property {string[]} [binNumbers] An Array of Bin Numbers for this Bin Lot
 ...
 * A **UserAccount** Type
 * 
 * @typedef {Object} FreshPackBinLotController.UserAccount
 ...
 * A **CommentItem** Type
 * 
 * @typedef {Object} FreshPackBinLotController.CommentItem
 * @property {string} id The Comment ID
 * @property {FreshPackBinLotController.UserAccount} userAccount 
