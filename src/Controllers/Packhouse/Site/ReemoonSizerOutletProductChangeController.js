...
import ReemoonSizerOutletProductChangeModel from '../../../Models/Packhouse/Site/ReemoonSizerOutletProductChangeModel';

/**
 * Controller Class for Reemoon Sizer Outlet Product Changes
 * 
 * @class
 */
class ReemoonSizerOutletProductChangeController
{
    /**
     * Retrieve a Reemoon Sizer Outlet Product Change [GET /packhouse/sites/{siteId}/reemoon-sizer-outlet-product-changes/{id}]
     * 
     * @static
     * @public
    ...
    static getOne(siteId, id)
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/reemoon-sizer-outlet-product-changes/${id}`)
            .then((result) => {
                let resolveValue = (function(){
                    return ReemoonSizerOutletProductChangeModel.fromJSON(result, siteId);
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.patchRequest(`/packhouse/sites/${siteId}/reemoon-sizer-outlet-product-changes/${id}`, updateData)
            .then((result) => {
                let resolveValue = (function(){
                    return ReemoonSizerOutletProductChangeModel.fromJSON(result, siteId);
                }());
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.deleteRequest(`/packhouse/sites/${siteId}/reemoon-sizer-outlet-product-changes/${id}`)
            .then((result) => {
                resolve(result ?? true);
            })
            .catch(error => reject(error));
     ...
     * @param {number} siteId The Site ID
     * @param {string} id The Reemoon Sizer Outlet Product Change ID
     * @return {Promise<Array<ReemoonSizerOutletProductChangeController.CommentItem>>}
     */
    static getComments(siteId, id)
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/reemoon-sizer-outlet-product-changes/${id}/comments`)
            .then((result) => {
                let resolveValue = (function(){
    ...
    /**
     * Create a Comment [POST /packhouse/sites/{siteId}/reemoon-sizer-outlet-product-changes/{id}/comments]
     * 
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.postRequest(`/packhouse/sites/${siteId}/reemoon-sizer-outlet-product-changes/${id}/comments`, {content})
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    /**
     * Retrieve a Comment [GET /packhouse/sites/{siteId}/reemoon-sizer-outlet-product-changes/{id}/comments/{commentId}]
     * 
     * Retrieves Comments for a Reemoon Sizer Outlet Product Change
     * 
     * @static
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/reemoon-sizer-outlet-product-changes/${id}/comments/${commentId}`)
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    /**
     * Update a Comment [PATCH /packhouse/sites/{siteId}/reemoon-sizer-outlet-product-changes/{id}/comments/{commentId}]
     * 
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.patchRequest(`/packhouse/sites/${siteId}/reemoon-sizer-outlet-product-changes/${id}/comments/${commentId}`, {content})
            .then((result) => {
                let resolveValue = (function(){
                    let resultObject = {};
    ...
    /**
     * Delete a Comment [DELETE /packhouse/sites/{siteId}/reemoon-sizer-outlet-product-changes/{id}/comments/{commentId}]
     * 
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.deleteRequest(`/packhouse/sites/${siteId}/reemoon-sizer-outlet-product-changes/${id}/comments/${commentId}`)
            .then((result) => {
                resolve(result ?? true);
            })
            .catch(error => reject(error));
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.getRequest(`/packhouse/sites/${siteId}/reemoon-sizer-outlet-product-changes`, queryParameters)
            .then((result) => {
                let resolveValue = (function(){
                    if(Array.isArray(result) !== true)
                    {
                    ...
                    return result.map((resultItem) => {
                        return (function(){
                            return ReemoonSizerOutletProductChangeModel.fromJSON(resultItem, siteId);
                        }());
                    });
                }());
    ...
    /**
     * Create a Reemoon Sizer Outlet Product Change [POST /packhouse/sites/{siteId}/reemoon-sizer-outlet-product-changes]
     * 
     * @static
     * @public
     * @param {number} siteId The Site ID
    ...
    {
        return new Promise((resolve, reject) => {
            RequestHelper.postRequest(`/packhouse/sites/${siteId}/reemoon-sizer-outlet-product-changes`, createData)
            .then((result) => {
                let resolveValue = (function(){
                    return ReemoonSizerOutletProductChangeModel.fromJSON(result, siteId);
                }());
...
export default ReemoonSizerOutletProductChangeController;
